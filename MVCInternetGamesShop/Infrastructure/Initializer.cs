    ...
    public class Initializer : DropCreateDatabaseAlways<ApplicationDbContext>
    {
        ...
        private static void SeedData(ApplicationDbContext context)
        {
            var games = new List<Game>
            {
                ...
                new Game () {Name="Mafia III", PlatformId = 3, Price = 244.09m, IsBestseller = true, Description = "Gra Mafia III na XBOX", ImageName="Mafia III.jpg", ReleaseDate= new DateTime(2015, 11, 11) },
                ...
                new Game () {Name="Life is strange", PlatformId = 2, Price = 255.94m, IsBestseller = true, Description = "Gra Life is Strange na PC", ImageName="LifeIsStrange.jpg", ReleaseDate= new DateTime(2015, 11, 11) },
